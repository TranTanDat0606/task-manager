...
const TitleHeaderGradientView = () => {
  return (
    <div className="flex flex-col items-center justify-center font-sans mb-[15px]">
      <TitleHeader className="text-4xl md:text-6xl font-bold">Task Manager</TitleHeader>
    </div>
  );
};

export default TitleHeaderGradientView;
