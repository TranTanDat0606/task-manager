...
import { CheckCircleFilled, DeleteOutlined, WarningOutlined } from "@ant-design/icons";
...
const Tasks = () => {
  ...
  return (
    <div
      className={`max-h-[400px] py-2 overflow-y-auto
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-semibold text-lg relative inline-block">
                          {task.name}
                          <span
                            className={`${task.completed ? "absolute left-0 right-0 top-[58%] h-[2px] bg-black" : ""}`}
                          ></span>
                        </span>
                      </div>
